...
interface BuildTimelineTrackSectionRenderStateProps {
  audioScrollY: number;
...
export function buildTimelineTrackSectionRenderState({
  audioScrollY,
  audioSectionHeight,
...
}: BuildTimelineTrackSectionRenderStateProps) {
...
export type TimelineTrackSectionRenderState = ReturnType<typeof buildTimelineTrackSectionRenderState>;
