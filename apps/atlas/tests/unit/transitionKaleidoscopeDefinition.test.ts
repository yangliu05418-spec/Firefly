...
describe('kaleidoscope transition definition', () => {
  it('uses the registered kaleidoscope effect on both transition participants', () => {
    ...
    expect(kaleidoscope.recipe).toEqual([
      {
        kind: 'opacity',
        target: 'outgoing',
        from: 1,
