...
export function CanvasWorkspaceGate(props: { canvasId: string; navigate: (path: string) => void }) {
  ...
  return enabled ? <Suspense fallback={<div className="canvas-v2-boot"><LoaderCircle className="spin" /> 正在载入画布内核</div>}><CanvasV2Workspace {...props} /></Suspense> : <LegacyCanvasWorkspace {...props} />;
}
