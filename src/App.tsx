...
import { Archive, ArrowRight, Check, ChevronRight, Copy, Download, Film, Home, ImageIcon, LayoutGrid, LoaderCircle, LogOut, Menu, MessageSquare, PanelLeftClose, Pencil, Play, Plus, RefreshCw, Search, Trash2, WandSparkles, X } from "lucide-react";
