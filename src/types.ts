...
export type UploadAsset = { id: string; uploadId?: string; name: string; type: "image" | "video" | "audio"; size: number; url?: string; assetId?: string; role: "reference_image" | "reference_video" | "reference_audio" | "first_frame" | "last_frame"; progress?: number; phase?: "preparing" | "uploading" | "verifying" | "ready"; preview?: string; status?: "Active" | "Processing" | "Failed"; normalized?: boolean };
