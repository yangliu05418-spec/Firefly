...
"[project]/node_modules/@splidejs/splide/dist/js/splide.esm.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/gsap/ScrambleTextPlugin.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var CharSet = /*#__PURE__*/ function() {
    function CharSet(chars) {
        this.chars = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])(chars);
        this.sets = [];
        this.length = 50;
        for(var i = 0; i < 20; i++){
...
var ScrambleTextPlugin = {
    ...
    init: function init(target, value, tween, index, targets) {
        ...
        data.original = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getText"])(target).replace(_spacesExp, " ").split("&nbsp;").join(""), delim, trim);
        if (text === "{original}" || text === true || text == null) {
            text = data.original.join(delim);
        }
        data.text = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])((text || "").replace(_spacesExp, " "), delim, trim);
        data.hasClass = !!(value.newClass || value.oldClass);
        data.newClass = value.newClass;
        data.oldClass = value.oldClass;
        splitByChars = delim === "";
        data.textHasEmoji = splitByChars && !!data.text.emoji;
        data.charsHaveEmoji = !!value.chars && !!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])(value.chars).emoji;
    ...
    render: function render(ratio, data) {
        ...
        if (rightToLeft) {
            if (ratio === 1 && (tween._from || tween.data === "isFromStart")) {
                ...
                if (charsHaveEmoji) {
                    startText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])(endText).slice(0, position - (textHasEmoji ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])(str) : str).length + 0.5 | 0).join("");
                } else {
                    startText = endText.substr(0, position - (textHasEmoji ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])(str) : str).length + 0.5 | 0);
                }
                endText = str;
            }
        } else {
            startText = text.slice(0, i).join(delimiter);
            i2 = (textHasEmoji ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])(startText) : startText).length;
            if (charsHaveEmoji) {
                endText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])(endText).slice(i2, position + 0.5 | 0).join("");
            } else {
...
ScrambleTextPlugin.emojiSafeSplit = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"];
ScrambleTextPlugin.getText = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getText"];
...
//# sourceMappingURL=node_modules_117yvmj._.js.map