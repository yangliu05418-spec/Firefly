...
export const MODELS: ModelCapability[] = [
  { id: "dreamina-seedance-2-5-260628", name: "Seedance 2.5", note: "最高质量 · 30 秒叙事", modes: advanced, resolutions: ["480p", "720p"], ratios, duration: [4, 30], imageLimit: 30, videoLimit: 10, audioLimit: 10, audioOnly: true, supportsAudio: true, outputFormats: ["mp4", "mov"] },
